...
//    @State private var region = MKCoordinateRegion(center: CLLocationCoordinate2D(latitude: 51.507222, longitude: -0.1275), span: MKCoordinateSpan(latitudeDelta: 10, longitudeDelta: 10))
    ...
    let mapLists = [
        ...
        MapList(adress: "17 Chem. du Manel, 31400 Toulouse", activity: "Découverte de la ferme", img: "lama", name: "Centre de dressage d'alpaca", time: "Du jeudi au dimanche de 10h00 à 18h00.",number: "Téléphone: 06.15.60.51.36", coordinate: CLLocationCoordinate2D(latitude: 43.6043, longitude: 1.4437)),
        MapList(adress: "Allée antoine bourdel, 31400 Toulouse", activity: "Atelier culinaire", img: "cooking", name: "Chez Sayyo", time: "Du mercredi au dimanche de 10h00 à 17h00.",number: "Téléphone: 06.20.30.21.16", coordinate: CLLocationCoordinate2D(latitude: 43.6043, longitude: 1.4037)),
